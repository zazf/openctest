...
CTEST_NETTY_SCTP_DIR = os.path.join(APP_DIR, "ctest-netty-sctp")
...
MODULE_PATH = {
    ...
    "netty-transport-sctp": CTEST_NETTY_SCTP_DIR
}
...
SRC_SUBDIR = {
    ...
    "alluxio-core": "core",
    "netty-transport-sctp": "transport-sctp",
}
...
MVN_TEST_PATH = {
    ...
    "netty-transport-sctp": os.path.join(CTEST_NETTY_SCTP_DIR, SRC_SUBDIR["netty-transport-sctp"]),
}
...
LOCAL_CONF_PATH = {
    ...
    "netty-transport-sctp": "results/netty-transport-sctp/conf_params.txt",
}
...
CTEST_SUREFIRE_PATH = {
    ...
    "netty-transport-sctp": [
        os.path.join(CTEST_NETTY_SCTP_DIR, SRC_SUBDIR["netty-transport-sctp"], SUREFIRE_SUBDIR)
    ],
}
...
LOCAL_SUREFIRE_PATH = {
    ...
    "netty-transport-sctp": [
        os.path.join("surefire-reports/netty/transport-sctp", LOCAL_SUREFIRE_SUFFIX)
    ],
}
