...
NETTY_SCTP = "netty-transport-sctp"
...
CTEST_NETTY_SCTP_DIR = os.path.join(APP_DIR, "netty-transport-sctp")
...
PROJECT_DIR = {
    ...
    NETTY_SCTP: CTEST_NETTY_SCTP_DIR,
}
...
SUREFIRE_DIR = {
    ...
    NETTY_SCTP: [os.path.join(CTEST_NETTY_SCTP_DIR, MODULE_SUBDIR[NETTY_SCTP], SUREFIRE_SUBDIR)],
}
...
DEFAULT_CONF_FILE = {
    ...
    NETTY_SCTP: os.path.join(DEFAULT_CONF_DIR, NETTY_SCTP + "-default.tsv"),
}
...
INJECTION_PATH = {
    ...
    NETTY_SCTP: [
        os.path.join(CTEST_NETTY_SCTP_DIR, "transport-sctp/ctest.json")
    ],
}
